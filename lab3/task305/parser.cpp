...
static const yytype_uint8 yyrline[] =
{
     ...
     120,   121,   124,   125,   128,   129,   133,   137,   138,   140,
     141,   143,   144,   146,   150,   152,   153,   155,   156,   157,
     158,   159,   160,   161,   165,   166,   168,   171,   172,   174,
     175,   179,   180,   181,   182,   183,   185,   186,   187,   188,
...
#line 1707 "parser.cpp"
  ...
  case 14:
#line 128 "parser.y"
           {(yyval.nIdentifier)=new NIdentifier(*(new std::string((yyvsp[0].type_id))),"OptTag");(yyval.nIdentifier)->line=yylineno-1;}
...
#line 1719 "parser.cpp"
  ...
  case 16:
#line 133 "parser.y"
        {(yyval.nIdentifier)=new NIdentifier(*(new std::string((yyvsp[0].type_id))),"Tag");(yyval.nIdentifier)->line=yylineno;}
...
#line 1875 "parser.cpp"
  ...
  case 42:
#line 180 "parser.y"
                            {(yyval.nExpression)=new NAssignment(*(new std::string("PLUSASS")),*(yyvsp[-2].nExpression),PLUSASS,*(yyvsp[0].nExpression));(yyval.nExpression)->line=yylineno; std::cout<<"E+E"<<std::endl;}
